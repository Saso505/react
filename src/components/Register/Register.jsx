      ...
      <div className='register  bg body items-center w-full justify-center flex h-screen '>
        <div className='container  items-center  justify-center flex  mx-auto'>
          <div className='row xsm:hidden lg:block '>
            <img
              className={`${style.imge}   lg::max-w-[34.758rem]  xl:max-w-[38.758rem] h-[40.758rem] `}
              src={logo}
              alt=''
            />
          </div>
            ...
            <form onSubmit={formik.handleSubmit}>
              <div className='glass-container sm:w-[34.758rem]  xl:w-[38.758rem] h-[40.758rem] xsm:w-[350px]    '>
                ...
                <div className='grid sm:grid-cols-2 w-3/4 sm:gap-8  xsm:gap-0 xsm:w-3/4  '>
                  <div className='relative mt-3 sm:mt-1 z-0 w-full sm:py-5 xsm:py-3 group '>
                    <input
                      ...
                      className='block sm:py-1 xsm:py-3 px-0 w-full text-md text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:b dark:focusborder-gray-300 focus:outline-none focus:ring-0 focus:border-gray-300  peer'
                      placeholder=' '
                    />
                    <label
                      htmlFor='userName'
                      className='peer-focus:font-medium  font-lato absolute text-lg text-gray-500 dark:text-white duration-300 transhtmlForm -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-gray-300  peer-focus:dark:text-gray-300 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-90 peer-focus:-translate-y-4'>
                      Username
                    </label>
                  ...
                  <div className='facebook'>
                    <div className='flex items-center justify-center w-12 h-12 rounded-full bg-white/50  shadow-md cursor-pointer hover:bg-gray-300  '>
                      <svg
                        ...
                        viewBox='0 0 320 512'
                        className='w-6 h-6 text-[rgb(25,30,63)]'>
                        <path
                          fill='#4267B2'
                ...
                <div className='realtive py-4  '>
                  <p className='text-white text-sm  absolute sm:left-[60%] xsm:top-[92.5%] sm:top-[89%]  xsm:py-1 xsm:mt-1 xsm:left-32'>
                    {" "}
